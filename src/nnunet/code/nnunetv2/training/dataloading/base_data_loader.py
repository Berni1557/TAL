...
class nnUNetDataLoaderBase(DataLoader):
    def __init__(self,
                 ...
                 select_only_labeled: bool = True):
        #print('infinite12345', infinite)
        ...
        #print('label_manager.all_labels123', label_manager.all_labels)
        self.annotated_classes_key = tuple(label_manager.all_labels)
        self.has_ignore = label_manager.has_ignore_label
        self.get_do_oversample = self._oversample_last_XX_percent if not probabilistic_oversampling \
            else self._probabilistic_oversampling
        self.select_only_labeled = select_only_labeled
    ...
    def get_bbox(self, data_shape: np.ndarray, force_fg: bool, class_locations: Union[dict, None],
        ...
        #print('need_to_pad123', need_to_pad)
        ...
        if not force_fg and not self.has_ignore:
            ...
            if voxels_of_that_class is not None and len(voxels_of_that_class) > 0:
                ...
                #print('selected_voxel1236', selected_voxel)
                #print('self.patch_size1236', self.patch_size)
